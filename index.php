    	...
    	<div class="content_top">
	      ...
	      ?>
				<div class="grid_1_of_4 images_1_of_4">
				 <a href="details.php?productid=<?php echo $result['productId'];?>"><img src="admin/<?php echo $result['image']; ?>" alt="" style="height: 200px; width: 200px" /></a>
...
<div class="content_top">
    		<div class="heading">
    		<h3 style="color: violet">General Products</h3>
    		</div>
    		<div class="clear"></div>
    	</div>
	      <div class="section group">
